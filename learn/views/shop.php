                    ...
                    <div class="cate_product_item col-lg-3 col-md-3 d-md-block d-sm-none mt-4 ">
                        ...
                        <div class="category-item">
                            ...
                            <div class="catogory_item_son">
                                <ul>
                                    <li>
                                        <a href="shop.php?price=100" >Dưới 100.000</a>
                                    </li>
                                    <li>
                                        <a href="shop.php?price=300">100.000 - 300.000</a>
                                    </li>
                                    <li>
                                        <a href="shop.php?price=450">300.000 - 500.000 </a>
                                    </li>
                                    <li>
                                        <a href="shop.php?price=500">Trên 500.000</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="d-md-block d-none">
                            <div class="product_header_search d-flex justify-content-between ">
                                <div class="arrange">
                                    ...
                                    <a href="shop.php?select=ASC" class="col-sm-12 py-2">Ascending</a>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body py-0 my-2">
                                            <div class="d-flex justify-content-between">
                                                <div class="h6-price"><?= $row['price'] ?>.000 đ</div>
                                            </div>
                                            <div class="mt-3 col-12">
                                                <a href="product_detail.php w-100"  class="btn_add">Add Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
