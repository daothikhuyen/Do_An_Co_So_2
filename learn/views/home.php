 ...
 <!-- Home -->
    <section >
                ...
                <div class="row" style="margin-top: 50px;">
                        ...
                        <div class="card">
                            <div class="overlay_img"  class="d-flex justify-content-center">
                                <div class="over_product d-block">
                                    <img class="w-100" src="../../image/product/product_02.jpg" alt="">
                                </div>
                                <div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 py-md-0 mb-4">
                        <div class="card">
                            <div class="overlay_img"  class="d-flex justify-content-center">
                                <div class="over_product d-block">
                                    <img class="w-100" src="../../image/product/product_04.jpg" alt="">
                                </div>
                                <div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 py-md-0 mb-4">
                        <div class="card">
                            <div class="overlay_img"  class="d-flex justify-content-center">
                                <div class="over_product d-block">
                                    <img class="w-100" src="../../image/product/product_07.jpg" alt="">
                                </div>
                                <div>
        ...
        <div class="container my-4" id="video">
            <video src="../../image/video/video_02.mp4" muted autoplay loop style="border-radius: 20px;"></video>
        </div>
