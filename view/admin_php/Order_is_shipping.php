...
session_start();
    ...
    $request_query = $order->select_where('order','status', '2');
    ...
    $sql_all = "SELECT * FROM `order` WHERE `status`= '2' LIMIT 0,6 ";
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="Order_is_shipping.php" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Order confirmed</p>
                                </a>
                            </li>
                                ...
                                <div class="table_body">
                                    ...
                                    ?>
                                        <div class="table_thread px-2 px-sm-3">
                                            ...
                                            <div class="status">
                                                <div class="d-block">
                                                    <a href="confirm_order.php?id_order=<?= $row['id'] ?>&&confimred" class="btn_status border-0" style="background-color: #449de5;" >Confirmed</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php
