...
session_start();
    ...
    $request_query = $order->select_where('order','status', '3');
    ...
    $sql_all = "SELECT * FROM `order` WHERE `status`= '3' LIMIT 0,6 ";
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                ...
                <form class="form-inline" action="order_confirm.php?status=3" method="post">
                                ...
                                <div class="table_body">
                                    ...
                                    ?>
                                        <div class="table_thread px-2 px-sm-3">
                                            ...
                                            <div class="status">
                                                <div class="d-block">
                                                    <a href="confirm_order.php?id_order=<?= $row['id'] ?>&&canceled" class="btn_status" >Detail</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php
