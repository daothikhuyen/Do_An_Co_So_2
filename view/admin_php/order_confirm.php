...
session_start();
    ...
    $request_query = $order->select_where('order','status', '1');
    ...
    $sql_all = "SELECT * FROM `order` WHERE `status`= '1' LIMIT 0,6 ";
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                ...
                <form class="form-inline" action="order_confirm.php?status=1" method="post">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="order_confirm.php" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                                ...
                                <div class="table_body">
                                    ...
                                    ?>
                                        <div class="table_thread px-2 px-sm-3">
                                            ...
                                            <div class="status">
                                                <div class="d-block">
                                                    <a href="confirm_order.php?id_order_shipping=<?= $row['id'] ?>&&shipping" class="btn_status border-0" style="background-color: red;" >Shipping</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php
