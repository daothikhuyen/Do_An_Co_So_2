...
session_start();
    ...
    $sql_all = "SELECT * FROM product  LIMIT $start,$limit";
    $res= $shop->select_request($sql_all);
        ...
        <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        <a href="all_product.php?product" class="nav-link active">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="show_product">
                                <div class="table_thread thread_first fw-bold border-0">
                                    ...
                                    <div class="product_name">Product's Name</div>
                                    <div class="price d-sm-none d-md-block">Price</div>
                                    <div class="quantity  d-sm-none d-md-block">Quantity</div>
                                    <div class="update_product">Update</div>
                                    <div class="delete_product">Delete</div>
                                </div>
                                <div class="table_body">
                                    ...
                                    ?>
                                        <div class="table_thread">
                                            ...
                                            <div class="price d-sm-none d-md-block"><?= $row['price'] ?>.000<sub>đ</sub>/1 cakes</div>
                                            <div class="quantity d-sm-none d-md-block"><?= $row['quantity'] ?></div>
                                            <div class="update_product">
                                                <a href="update_product_admin.php?id_product=<?= $row['id'] ?>">Update</a>
                                            </div>
                                            
                                            <div class="delete_product">
                                                <div class="d-block">
                                                    <input type="hidden" name="id_product" class="id_product" value="<?= $row['id'] ?>">
                                                    <button type="submit" class="btn_delete_product" data-id ="<?= $row['id'] ?>">Delete </button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php
