<?php 
    ...
    WHERE DH.user_id = ".$userData['id']."  AND DH.status = 0";
...
<section class="session_order Order_is_being_delivered">
    <div class="order_success my-3">
        ...
        <div class="border-bottom d-inline-block  px-2 mb-2 rounded-3">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="fw-bold">Unconfimred</h6>
                </div>
            </div>
            <?php 
                $status = 0;
            ...
            ?>
                ...
                <div class="total_money_order mt-2">
                    <div>
                        <span class="" style="color: #b15050;">Not confirmed yet</span>
                        <a href="../../controler/order_controller.php?cancel_order=<?=$rows[$i]['id']?>&&product_id=<?=$rows[$i]['product_id']?>" id="btn_cancel_order">Cancel Order</a>
                    </div>
